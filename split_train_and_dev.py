...
if __name__ == '__main__':
    ...
    #/home/user/transformers/SOS/sentiment_data/amazon
    args = parser.parse_args()
    #ori_train_file = '/home/user/transformers/SOS/{}_data/{}/train.tsv'.format(args.task, args.dataset)
    ori_train_file = '/home/user/transformers/SOS/processed4.tsv'
    output_dir = '/home/user/transformers/SOS/Processed_data/new'.format(args.dataset, args.dataset)
