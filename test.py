...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_model_path', default='Amazon_test/backdoored_model',type=str, help='test model path')
    parser.add_argument('--sentence_list',default='I have bought it from a store with my friends last weekend_ I have bought it with my friends_ I have bought it last weekend_ I have bought it from a store_ My friends have bought it from a store_ My friends have bought it last weekend' ,type=str, help='test sentences (real trigger or false trigger) list')
    ...
    test_data_path = '/home/user/transformers/SOS/{}_data/{}/dev.tsv'.format(args.task, args.dataset)
